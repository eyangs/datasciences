...
plot(power.data$DateTime, power.data$Global_active_power, type="l", ylab="Global Active Power", xlab="")

plot(power.data$DateTime, power.data$Voltage, type="l", ylab="Voltage", xlab="")
...
plot(power.data$DateTime, power.data$Global_reactive_power, type="l", ylab="Global reactive Power", xlab="")
dev.off()
